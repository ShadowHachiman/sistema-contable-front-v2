...
export class AuthService {
  ...
  login(credentials: any): Observable<LoginResponse> {
    // En una aplicación real, aquí se enviarían las credenciales
  ...
  // MÉTODO CLAVE para el *ngIf en el app.html (Layout vs Login)
  isLoggedIn(): boolean {
  ...
  logout(): void {
    ...
    // Nota: en una app real, aquí también redirigirías al login
  }
}
